    ...
    <div className="flex" style={{ gap: `${gap}px` }}>
      {socialIcons.map((social) => (
        <a
          ...
          className={`group relative rounded-full flex items-center justify-center transition-all duration-300 hover:scale-105 ${variant === "neumorphic" ? "" : "backdrop-blur-[4px]"
